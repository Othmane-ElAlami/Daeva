    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Zap size={12} /> Aion 2 Build Intelligence
          </span>
        </div>
                          ...
                          <div className="grid-cols-3">
                            {group.slots.map(([slot, stats], slotIdx) => {
                              ...
                              const classifyStatType = (name, values) => {
                                ...
                                // Offense keywords
                                if (
                                  /\b(attack|damage|crit|might|precision|penetration|pierce|smite|hit|chance|boost|strike|additional|speed|accuracy|power|strength|intelligence|impact)\b/.test(
                                    n,
                                  )
                                )
                                  return "offense";
                                // Defense keywords
                                if (
                                  /\b(def|defense|resist|hp|block|parry|evasion|endurance|willpower|constitution|health|tolerance|heal|regeneration|suppression|vitality|back defense|defense increase)\b/.test(
                                    n,
                                  )
                                )
                                  return "defense";
                                // Utility keywords
                                if (
                                  /\b(mp|mana|cooldown|cast|move|regen|dexterity|agility)\b/.test(
                                    n,
                                  )
                                )
                                  return "utility";
